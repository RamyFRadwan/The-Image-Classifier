...
def main():
    ...
    number = input.top_k
    categ_names = input.category_names
    gpu = input.gpu
    
    # load category names file
    with open(categ_names, 'r') as f:
        categ_to_name = json.load(f)
    ...
    probs, classes = predict(path_to_image, model, number)
...
def get_args():
    ...
    parser.add_argument("image_path", type=str, help="Image Path to be Predicte")
    parser.add_argument("checkpoint", type=str, default="checkpoint_2.pth" ,help="Trained Model Checkpoint")
    parser.add_argument("--top_k", type=int, default=5, help="Classes to be predicted count")
    parser.add_argument("--category_names", type=str, default="cat_to_name.json",
                        help="Category Names Dictionary")
    parser.add_argument("--gpu", type=bool, default=True,
                        help="GPU/CPU for moddel training: True = GPU, False = CPU")
