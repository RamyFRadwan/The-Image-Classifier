...
def get_args():
    ...
    parser.add_argument("data_directory", type=str, default="home/workspace/flowers" ,help="Testing/Training Data directory")
    parser.add_argument("--save_dir", type=str, default="checkpoint_2.pth",
                        help="Model Checkpoint directory")
    parser.add_argument("--arch", type=str, default="vgg",
                        help="Choose Pre-trained Model: vgg16, resnet18, alexnet")
    ...
    while e < epochs:
        ...
        for inputs, labels in iter(trainloader):
            ...
            if steps % print_every == 0:
                # inference
                model.eval()
                val_loss, accuracy = valid(criterion, model, validloader, gpu)
...
def valid(criterion, model, validloader, gpu):
    correct = 0
    total = 0
    val_loss = 0
